...
public class PolymorphiaTest {
    ...
    private Maze create2x2MazeWithOneAdventureAndOneCreature() {
        Maze maze = MazeTest.create2x2GridMaze();
    ...
    void testOneRoom() {
        ...
        // Arrange
        List<Room> rooms = List.of(new Room("onlyRoom"));
    ...
    public void test2x2Game() {
        // Arrange
        Maze maze = create2x2MazeWithOneAdventureAndOneCreature();
        Polymorphia game = new Polymorphia(maze);
    ...
    public void test3x3Game() {
        // Arrange
        Maze maze = create3x3MazeWithAdventurersCreaturesAndFood(2,5,10);
        Polymorphia game = new Polymorphia(maze);
